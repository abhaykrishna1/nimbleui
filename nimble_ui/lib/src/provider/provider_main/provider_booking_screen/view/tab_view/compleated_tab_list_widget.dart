...
import 'package:nimple_ui/src/provider/provider_main/provider_booking_screen/view/tab_view/provider_compleated_show_dialog.dart';
import 'package:nimple_ui/utils/color_palate.dart';
import 'package:nimple_ui/utils/font_palette.dart';
import 'package:nimple_ui/widget/type_widget.dart';

class ProviderCompleatedListWidget extends StatelessWidget {
  const ProviderCompleatedListWidget({super.key});
                ...
                Expanded(
                  child: Padding(
                    padding: EdgeInsets.only(
                        left: 8.0, right: 8, top: 12.h, bottom: 12.h),
                    child: Column(
