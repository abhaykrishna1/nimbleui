...
class MobileRegistrationScreenn extends StatelessWidget {
  const MobileRegistrationScreenn({super.key});
            ...
            children: [
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.pushNamed(
                        context,
                        RouteGenerator.routeLoginMobileScreen,
                      );
                    },
                    child: Text(
                      Constants.login,
              ...
              CustomButton(
                  ...
                  onpressed: () {
                    Navigator.pushNamed(
                      context,
                      RouteGenerator.routeMobileRegistrationOtpScreen,
                    );
                  })
            ],
          ),
